...
/* 
    - First use our router variable, then detail the type of method we want to use: CRUD methods
...
router.post("/json", (request, response) => {
    // This console log will be printed in my vscode terminal that's running the server
