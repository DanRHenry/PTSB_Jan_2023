...
/* 
    ...
    - Allows for inheritance of behavior(method/functionality) via parent class that can share methods.
...
// console.log(`${tiny.name} goes woof!`) // Not as flexible or clean code compared to the method.
...
class Tab {
    constructor(sub, tax) {
        this.subtotal = sub;
        this.tax = tax;
        this.tip; // This is similar to using: let tip;
    }
