...
/* 
    If Else Statement: gives us a no (false) response if the isn't true or valid. A true code block and a false code block.
*/

let weather = 65;

if (weather < 70) {
    console.log("Wear a jacket, it's chily.");
} else {
